...
class _NextGenNowPlayingState extends State<_NextGenNowPlaying>
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  _buildTimerOption(context, cubit, AppLocalizations.of(context)!.min5, const Duration(minutes: 5)),
                  _buildTimerOption(context, cubit, AppLocalizations.of(context)!.min15, const Duration(minutes: 15)),
                  _buildTimerOption(context, cubit, AppLocalizations.of(context)!.min30, const Duration(minutes: 30)),
                  _buildTimerOption(context, cubit, AppLocalizations.of(context)!.min45, const Duration(minutes: 45)),
                  _buildTimerOption(context, cubit, AppLocalizations.of(context)!.hour1, const Duration(hours: 1)),
                  _buildTimerOption(context, cubit, AppLocalizations.of(context)!.hours2, const Duration(hours: 2)),
                ],
              ),
              ...
              Padding(
                ...
                child: OutlinedButton.icon(
                  onPressed: () {
                    Navigator.pop(context); // Fermer le bottom sheet d'abord
                    _showCustomTimerDialog(context, cubit);
                  },
                  icon: const Icon(Icons.edit_outlined),
                  label: Text(AppLocalizations.of(context)!.customize),
                  style: OutlinedButton.styleFrom(
                    minimumSize: const Size(double.infinity, 48),
                    foregroundColor: _vibrantColor,
                    side: BorderSide(color: _vibrantColor.withValues(alpha: 0.5)),
              ...
              if (cubit.isSleepTimerActive) ...[
                ...
                Padding(
                  ...
                  child: FilledButton.tonalIcon(
                    ...
                    label: Text(AppLocalizations.of(context)!.cancelTimer),
  ...
  Widget _buildTimerOption(BuildContext context, PlayerCubit cubit, String label, Duration duration) {
    return FilledButton(
      onPressed: () {
        cubit.startSleepTimer(duration);
        Navigator.pop(context);
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context)!.sleepTimerSet(label)),
      ...
      style: FilledButton.styleFrom(
        ...
        backgroundColor: _vibrantColor.withValues(alpha: 0.3),
  ...
  void _showCustomTimerDialog(BuildContext context, PlayerCubit cubit) {
    int selectedHours = 0;
    int selectedMinutes = 26;
    
    final FixedExtentScrollController hoursController = FixedExtentScrollController(initialItem: selectedHours);
    final FixedExtentScrollController minutesController = FixedExtentScrollController(initialItem: selectedMinutes);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                // Titre
                Text(
                  AppLocalizations.of(context)!.stopMusicAfter,
                  style: TextStyle(
                ...
                // Picker Heures : Minutes : Secondes
                SizedBox(
                  height: 200,
                  child: Row(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Container(
                              height: 60,
                              decoration: BoxDecoration(
                                color: _vibrantColor.withValues(alpha: 0.15),
                                borderRadius: BorderRadius.circular(12),
                              ),
                            ),
                                  ...
                                  return Center(
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.bold,
                                        color: isSelected ? _vibrantColor : Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.3),
                                      ),
                                    ),
                                  );
                                },
                      ...
                      child: FilledButton(
                        onPressed: () {
                          if (selectedHours == 0 && selectedMinutes == 0) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text(AppLocalizations.of(context)!.invalidDuration)),
                            );
                            return;
                          }
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(AppLocalizations.of(context)!.sleepTimerSet('${selectedHours}h ${selectedMinutes}min')),
                              duration: const Duration(seconds: 2),
                            ),
                          );
                        },
